...
ʙᴏᴛ ʜᴀɴᴅʟᴇ ʙʏ [𝘽𝙤𝙩 𝘿𝙪𝙣𝙞𝙮𝙖](https://t.me/bestii_friend_forever)
Thanks to add me 😇**
        """,
            ...
            [
                [
                    InlineKeyboardButton(
                        "Handle", url="https://t.me/The_Godfather_Network"
                    ),
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                       " 𝐒𝐮𝐩𝐩𝐨𝐫𝐭👿", url="https://t.me/bestii_friend_forever"
                    ),
                    InlineKeyboardButton(
                        "𝐔𝐩𝐝𝐚𝐭𝐞𝐬", url="https://t.me/international_hindi_chatting"
                    )
                ],[
                    InlineKeyboardButton(
